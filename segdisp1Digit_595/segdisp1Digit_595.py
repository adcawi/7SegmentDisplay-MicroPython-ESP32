...
# 6 Pins in total are needed for the shift register. 3 for SPI, 3 GPIO Pins.
...
def initPins_1Digit_595(spiObject, rclk, oe, clr):
...
def testDisplay_1Digit_595():

	for i in numbers:
		time.sleep_ms(250)
		writeToDisplay_1Digit_595(i)
	for j in letters:
		time.sleep_ms(250)
		writeToDisplay_1Digit_595(j)	
	for k in special:
		time.sleep_ms(250)
		writeToDisplay_1Digit_595(k)
